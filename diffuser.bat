...
py .\scripts\pip.exe install g://projects//stable-diffusion-webui-amd//ort_nightly_directml-1.13.0.dev20221021004-cp310-cp310-win_amd64.whl --force-reinstall

huggingface-cli.exe login
v14 = "CompVis/stable-diffusion-v1-4"
v15 = "runwayml/stable-diffusion-v1-5"
v15p = "g://projects//stable-diffusion-webui-amd//models//Stable-diffusion//v1-5-pruned.ckpt"
...
#G:\Projects\Stable-Diffusion-webui-amd\convert_stable_diffusion_checkpoint_to_onnx.py --model_path="runwayml/stable-diffusion-inpainting" --output_path="g://projects//stable-diffusion-webui-amd//diffusers//examples//inference/onnx15inpaint"
#G:\Projects\Stable-Diffusion-webui-amd\convert_stable_diffusion_checkpoint_to_onnx.py --model_path="g://projects//stable-diffusion-webui-amd//models//Stable-diffusion//sd-v1-5-inpainting.ckpt" --output_path="g://projects//stable-diffusion-webui-amd//diffusers//examples//inference/onnx15inpaint"